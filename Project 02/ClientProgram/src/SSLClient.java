...
public class SSLClient {
    ...
    public final static String MESSAGE_TO_TLS_SERVER = "71959COMP416";
    public final static int TLS_SERVER_PORT = 9999;
    ...
    public SSLClient() {
         ...
         */
        sslConnectToServer.SendForAnswer(MESSAGE_TO_TLS_SERVER);
